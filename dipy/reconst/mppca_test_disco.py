...
def denoise_tv_chambolle_K_4d(data_4d, K):
    ...
    for voxelt in range(data_4d.shape[3]):
        ...
        mask, affine = load_nifti(r"/home/ekin/Desktop/mppca_test_disco/DiSCo1_mask.nii.gz")
        #maskk = mask[:,:,:,0,0]
        maskk = mask
...
data_noisy, affine = load_nifti(r"/home/ekin/Desktop/mppca_test_disco/data_snr20_set1.nii.gz")
bvals, bvecs = read_bvals_bvecs(r"/home/ekin/Desktop/mppca_test_disco/DiSCo_1_shell.bvals", r"/home/ekin/Desktop/mppca_test_disco/DiSCo_1_shell.bvecs")
...
mppca_mask, affine2 = load_nifti(r"/home/ekin/Desktop/mppca_test_disco/DiSCo1_mask.nii.gz")
#data = mppca(data_noisy, patch_radius=2)
#save_nifti(r"/home/ekin/Desktop/mppca_test_disco/denoised_disco.nii.gz", data, affine)
data, affine = load_nifti(r"/home/ekin/Desktop/mppca_test_disco/denoised_disco.nii.gz")
gtab = gradient_table(bvals, bvecs)

# infer response from mask
mask = mask_for_response_ssst(gtab, data, roi_radii=10, fa_thr=0.6)
...
#nib.save(fods_img, r"/home/ekin/Desktop/mppca_test_disco/mppca_csd_12_descoteaux.nii.gz")
sh_coeff, affine = load_nifti(r"/home/ekin/Desktop/mppca_test_disco/mppca_csd_12_descoteaux.nii.gz")
...
#nib.save(fods_img,  r"/home/ekin/Desktop/mppca_test_disco/mppca_csd_12.nii.gz")

K_range = {'K': np.arange(0.5, 5, 0.1)}
...
#nib.save(fods_img,  r"/home/ekin/Desktop/mppca_test_disco/mppca_prior_descoteaux.nii.gz")
#tournier_thr_sh_coeff = np.dot(thr_sh_coeff, conversion_matrix.T)
#fods_img2 = nib.Nifti1Image(tournier_thr_sh_coeff, affine)
#nib.save(fods_img2,  r"/home/ekin/Desktop/mppca_test_disco/mppca_prior.nii.gz")
...
nib.save(fods_img, r"/home/ekin/Desktop/mppca_test_disco/j_invariance_sr2csd.nii.gz") 
