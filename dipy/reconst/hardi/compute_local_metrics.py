...
niiGT = nib.load(r"/home/ekin/Downloads/dipy_Ekin/dipy/reconst/hardi/ground-truth-peaks.nii.gz")
...
niiMASK = nib.load(r"/home/ekin/Downloads/dipy_Ekin/dipy/reconst/hardi/mask_compute_local_metrics.nii.gz")
#niiMASK_hdr = niiMASK.get_header()
niiMASK_img = niiMASK.get_fdata()

#niiMASK_dim = niiMASK_hdr.get_data_shape()
niiMASK_dim = niiMASK_img.shape
...
########################
#SUBMISSIONs = glob.glob( r"C:\Users\ekint\OneDrive\Masaüstü\PGD\hardi\super_res_hardi\reconstructions_thr0.3\*.nii.gz" )
SUBMISSIONs = glob.glob( r"/home/ekin/Desktop/hardi_doublecheck/hardi_test/peaks/*.nii.gz" )
...
for filename in SUBMISSIONs:
    ...
    niiRECON_img = np.append(niiRECON_img, np.zeros((50,50,50,6)), axis=3)
    #niiRECON_dim = niiRECON_hdr.get_data_shape()
    niiRECON_dim = niiRECON_img.shape
...
XLS.save(r"/home/ekin/Desktop/hardi_doublecheck/hardi_test/results.xls")
