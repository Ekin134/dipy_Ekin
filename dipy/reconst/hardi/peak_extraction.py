...
def peak_extraction(odfs_file, sphere_vertices_file, out_file, relative_peak_threshold=.5,
    ...
    sphere= HemiSphere.from_sphere(sphere_2890)
    ...
    for index in ndindex(odfs.shape[:-1]):
        ...
        if peak_normalize == 1 and len(values) != 0:
            values /= values[0]
    ...
    peaks_img = nib.Nifti1Image(peaks.astype(np.float32), np.eye(4))
...
def main():
    ...
    spherical_functions_file = r"/home/ekin/Desktop/hardi_doublecheck/hardi_test/sf_sr2csd.nii.gz"
    #sphere_vertices_file = args.sphere_vertices_file
    sphere_vertices_file = r"/home/ekin/Desktop/no_mppca/hardi_snr20_set1/sphere724.txt"
    #out_file = args.out_file
    out_file = r"/home/ekin/Desktop/hardi_doublecheck/hardi_test/peaks/peaks_sr2csd.nii.gz"
